...
<title>Civil Savant Online Examination || DASHBOARD </title>
...
<body  style="background-image: url('image/bg3.jpg'); height: 500px; /* You must set a specified height */
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Civil Savant Online Examination</span></div>
<?php
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li <?php if(@$_GET['q']==1) echo'class="active"'; ?>><a href="dash.php?q=1">Applicants</a></li>
		<li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="dash.php?q=2">Result</a></li>
		<li <?php if(@$_GET['q']==3) echo'class="active"'; ?>><a href="dash.php?q=3">User Logs</a></li>
...
$result = mysqli_query($con,"SELECT * FROM user WHERE id=$apid") or die('Error');
...
<div class="form-group" hidden>
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input  id="college" name="college" value="Federal university Dutse" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <option value="Agric">Agric</option> </select>
  </div>
</div>
<!-- Text input-->
<div class="form-group">
  ...
  <option value="06">Level 08</option>
...
<?php if($employment==1){
 ...
 $emp='<a href="employed.php?apid='.$id.'">Not Employed</a>';
}?>
<?php
echo'<td>'.$emp.'</td>';
}
...
while($row = mysqli_fetch_array($result)) {
  ...
  <td>'.$mob.'</td>
	<td>
  <a title="Edit" href="dash.php?q=6&apid='.$id.'"><b><span class="glyphicon glyphicon-edit" aria-hidden="true"></span>Edit</b></a>
  
  <a hidden title="Delete User" href="update.php?demail='.$email.'"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a>
  </td>
  </tr>';
}
$c=0;
