  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a class="navbar-brand" href="#"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span>&nbsp; Applcation</a></li>
        <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active"'; ?>">
          ...
          <ul class="dropdown-menu">
            <li><a href="account.php?q=1">Start Exam</a></li>
...
<td>'.$time.'&nbsp;min</td>
	<td>
  <b><a href="account.php?q=result&eid='.$eid.'&n=1&t='.$total.'" class="pull-right btn sub1" style="margin:0px;background:green;color:#fff;">
  <span class="glyphicon glyphicon-eye" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Result</b></span>
  </a></b></td>
  <th colspan="5">TOTAL SCORE: 0</th></tr>';
